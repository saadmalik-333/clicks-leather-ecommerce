...
<body>
    ...
    <div class="header-container" id="site-header">
        ...
        <header class="main-header">
            <div class="header-left">
                <svg class="icon-location" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"></path><circle cx="12" cy="10" r="3"></circle></svg>
                <span class="location-text">Pakistan (PKR Rs)</span>
            </div>
            ...
            <div class="header-right">
                <div class="header-icons">
                    ...
                    <?php if (is_logged_in()): ?>
                        <a href="<?= is_admin() ? ADMIN_URL . '/dashboard.php' : '#' ?>" class="icon-link" title="Account">
        ...
        <nav class="main-nav">
            <ul class="nav-categories">
                ...
                <li class="nav-highlight"><a href="#">LADIES BAGS</a></li>
    ...
    <section class="categories-section" id="categories">
        ...
        <div class="categories-grid">
            ...
            ?>
                <div class="category-card" id="category-<?= $cat['id'] ?>">
    ...
    <script>
        ...
        // Multi-Stage Header Scroll Effect
        let isTicking = false;
