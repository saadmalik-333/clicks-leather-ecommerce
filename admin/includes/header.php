        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                <li class="<?= $current_page === 'orders.php' ? 'active' : '' ?>">
                    <a href="<?= ADMIN_URL ?>/orders.php" id="nav-orders">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <li class="<?= $current_page === 'low_stock.php' ? 'active' : '' ?>">
                    <a href="<?= ADMIN_URL ?>/low_stock.php" id="nav-low-stock">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <li class="<?= $current_page === 'messages.php' ? 'active' : '' ?>">
                    <a href="<?= ADMIN_URL ?>/messages.php" id="nav-messages">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <li class="<?= $current_page === 'change-password.php' ? 'active' : '' ?>">
                    <a href="<?= ADMIN_URL ?>/change-password.php" id="nav-change-password">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
